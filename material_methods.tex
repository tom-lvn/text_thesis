...
purse seiner class \figref{fig:vessel_classification}. \medskip
\begin{figure}[htbp]
	\centering
	\resizebox{\textwidth}{!}{%
		\begin{forest}
...
shapefile of the Mediterranean Sea \figref{fig:study_area}, obtained from the General Fisheries
...
seines, and that were registered with ICCAT were retained \figref{fig:workflow}. These gear types
